...
const Cart = () => {
  ...
  const handleCheckout = () =>{
    dispatch(emptyCart())
    alert("Oder confirmed....Thank You for purchasing with  us!!!!!")
    navigate('/')
  }
  ...
  return (
    <>
      <Header />
      <div style={{ paddingTop: '100px' }} className="container px-4 mx-auto pb-10">
        {
          userCart?.length > 0 ?
            <>
                          ...
                          <tr key={product?.id}>
                            ...
                            <td>
                              <div className="">
                                ...
                                <input style={{ width: '40px' }} value={product?.quantity} className='border rounded p-1 mx-2' type="text" readOnly />
